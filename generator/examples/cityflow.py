...
def pre_aggregation(last_host_id, last_container_id, last_link_id, starting_address) :
    ...
    host1 = topology_root[host1_id]['id'] # TODO: immediately retrieve reference to host object instead of host_id
    ...
    # Adding a host to topology root for next batch of pre aggregation rings
    host3_id = gen_components.add_host( topology_root )
    ...
    host4_id = gen_components.add_host( topology_root )
...
def pre_aggregation_rings(host, components, hosts_per_ring, rings) :
    ...
    br2_component = gen_components.create_bridge( host )
    ...
    gen_components.connect_components( br1_component, br2_component, addressing_scheme )
...
def pre_aggregation_ring(host, components, br1_component, br2_component, hosts_per_ring, addressing_scheme) :
    ...
    gen_components.connect_components( ring_component, br2_component, addressing_scheme )
